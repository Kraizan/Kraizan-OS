...
const Explorer = () => {
  ...
  return (
    <div className="w-full h-full flex bg-background">
      <div className="w-1/5 bg-background-dark p-4">
        ...
        <ul>
          {Object.values(folderStructure.root.children.Home.children).map(
            (folder: any) => (
              ...
              >
                <img src={folder.image} alt={folder.name} className="w-8 h-8" />
      ...
      <div className="w-4/5 flex flex-col">
        <div className="flex items-center bg-background-dark p-2">
          <button
            onClick={goBack}
